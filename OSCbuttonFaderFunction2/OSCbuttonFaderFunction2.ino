...
char ssid[] = "mitmedialab";          // your network SSID (name)
char pass[] = "signalnoise";                    // your network password

WiFiUDP Udp;                                // A UDP instance to let us send and receive packets over UDP
const IPAddress outIp(10, 100, 2, 5);     // remote IP of your computer
